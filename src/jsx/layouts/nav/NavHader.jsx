...
import leftLogo from "../../../assets/images/logo1.png"
import rightLogo from "../../../assets/images/logo2.png"
	...
	return (
		<div className="nav-header">
			<Link to="/dashboard" className="brand-logo">
				...
				<span className="logo-abbr"><img src={leftLogo} alt="" /></span>
				<span className="brand-title"><img src={rightLogo} alt="" /></span>
				{/* <img src={logoImg} alt="" /> */}
				{/* <span className="text-upppercase" >lernhilfe-sprenge</span> */}
			</Link>
