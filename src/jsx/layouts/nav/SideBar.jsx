    ...
    >
      <div className="dlabnav-scroll">
          ...
          <div className="copyright">
            {/* <p> Lernhilfe-Sprenger.com Dashboard © {dat.getFullYear()} All Rights Reserved</p> */}
            {/* <p className="fs-12">Designed By: <a href="https://www.thewisewebdesign.com/" target="_blank">thewisewebdesign</a></p> */}
            {/* <p className="fs-12">Made with <span className="heart"onClick={(e)=>e.target.classList.toggle('heart-blast')}></span> by DexignLab</p> */}
          </div>
      </div>
    </div>
  );
